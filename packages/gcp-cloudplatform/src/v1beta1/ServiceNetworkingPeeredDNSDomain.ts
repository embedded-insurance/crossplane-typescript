 ...
 */
export type ServiceNetworkingPeeredDNSDomain = {
  /**
  ...
  spec: {
     ...
     */
    deletionPolicy?: io_upbound_gcp_cloudplatform_v1beta1_ServiceNetworkingPeeredDNSDomain.deletionPolicy;
    forProvider: {
      /**
     ...
     */
    managementPolicy?: io_upbound_gcp_cloudplatform_v1beta1_ServiceNetworkingPeeredDNSDomain.managementPolicy;
    /**
    ...
    providerConfigRef?: {
      ...
      policy?: {
         ...
         */
        resolution?: io_upbound_gcp_cloudplatform_v1beta1_ServiceNetworkingPeeredDNSDomain.resolution;
        /**
         * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
         */
        resolve?: io_upbound_gcp_cloudplatform_v1beta1_ServiceNetworkingPeeredDNSDomain.resolve;
      };
    };
    /**
...
export namespace io_upbound_gcp_cloudplatform_v1beta1_ServiceNetworkingPeeredDNSDomain {

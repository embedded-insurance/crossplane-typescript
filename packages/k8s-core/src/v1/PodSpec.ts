...
import type { EphemeralContainer } from './EphemeralContainer'
...
import type { PodOS } from './PodOS'
import type { PodReadinessGate } from './PodReadinessGate'
 ...
 * - `"OnFailure"`
 */
export type  RestartPolicy = 'Always' | "Never" | "OnFailure";
